...
# Absolute path to nlm
nlm_path = r"c:\Users\ubunt\안티그래비티\todo-list\notebooklm-mcp\.venv\Scripts\nlm.exe"
...
# Set CWD to user home to avoid globbing the massive .venv or project dirs if that's the cause
cwd = r"c:\Users\ubunt"
